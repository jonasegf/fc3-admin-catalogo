...
public class CategoryTest {
  ...
  public void givenAnInvalidNameLengthGreaterThan255_WhenCallNewCategoryAndValidate_thenShouldReceiveError() {
    final String expectedName = """
        Do mesmo modo, o entendimento das metas propostas representa uma abertura para a melhoria dos �ndices
        pretendidos. Desta maneira, o novo modelo estrutural aqui preconizado garante a contribui��o de um grupo
        importante na determina��o das condi��es financeiras.
        """;
    final var expectedErrorCount = 1;
    final var expectedErrorMessage = "'name' must be between 3 and 255 characters";
    final var expectedDescription = "A categoria mais assistida";
  ...
  @Test
  public void givenAValidNameEmptyDescription_WhenCallNewCategoryAndValidate_thenShouldReceiveError() {
    final var expectedName = "Filmes";
  ...
  @Test
  public void givenAValidFalseIsActiveNameEmptyDescription_WhenCallNewCategoryAndValidate_thenShouldReceiveError() {
    final var expectedName = "Filmes";
    final var expectedDescription = "A categoria mais assistida";
